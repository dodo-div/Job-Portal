...
job_controller = """const Job = require('../models/Job');
...
app_controller = """const Application = require('../models/Application');
...
with open('./controllers/jobController.js', 'w', encoding='utf-8') as f:
    f.write(job_controller)

with open('./controllers/applicationController.js', 'w', encoding='utf-8') as f:
    f.write(app_controller)

print('Both controllers written successfully!')
print('jobController size:', os.path.getsize('./controllers/jobController.js'), 'bytes')
print('applicationController size:', os.path.getsize('./controllers/applicationController.js'), 'bytes')